...
console.log("Increase profits:" + greatestIncreaseMonth + greatestIncrease);
...
console.log('Decrease in profits: ' + greatestDecrease.month + ' ' + greatestDecrease.profit);
...
console.log("Average Change: "+ "$" + averageChange.toFixed(3))
